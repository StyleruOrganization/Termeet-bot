...
class CommunicationChannelGRPC(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
...
class FeedbackSchemaGRPC(_message.Message):
    ...
    contact: str
    message: str
    def __init__(self, type: _Optional[_Union[FeedbackTypeGRPC, str]] = ..., communication_channel: _Optional[_Union[CommunicationChannelGRPC, str]] = ..., contact: _Optional[str] = ..., message: _Optional[str] = ...) -> None: ...
...
class FeedbackResponseGRPC(_message.Message):
    ...
    def __init__(self, feedbacks: _Optional[_Iterable[_Union[FeedbackSchemaGRPC, _Mapping]]] = ...) -> None: ...
